...
{
      11,     0,    -1,    12,     7,    13,     9,    -1,    -1,     3,
       4,     5,     8,    12,    -1,    -1,    14,    13,    -1,     5,
      -1,     3,    -1,     8,    -1
};
...
{
  "$end", "error", "$undefined", "VARNAME", "EQUAL", "WORD", "TEXT",
  "SEPERATOR", "ENDLINE", "EOI", "$accept", "input", "rules", "main_text",
  "word", YY_NULL
};
#endif
